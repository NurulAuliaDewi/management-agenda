...
<html lang="en">
 ...
 <div class="row no-gutters">
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fa-solid fa-clock-rotate-left mr-2"></i>RIWAYAT RAPAT</h3><hr>
      <div class="card text-center">
        <div class="card-header">
          <ul class="nav nav-pills card-header-pills">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark" href="#">Selesai</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-dark" href="#">Dibatalkan</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
          <table class="table">
            ...
            <tbody class="table-group-divider">
              <tr>
                <th scope="row">1</th>
                <td>06 Oktober 2017</td>
                <td>09:00:00 - 11:00:00</td>
                <td>Koordinasi P Aset : -Koordinasi antara Administrasi Aset dengan Pemeliharaan Aset</td>
                <td>Agus 081914067428</td>
                <td><i class="fa-solid fa-circle-dot mr-2"></i>Selesai</td>
                <td><i class="fa-solid fa-question bg-info p-2 text-white rounded" data-toogle="tooltip" title="Info"></i></td>
              </tr>
               <tr>
                <th scope="row">2</th>
                <td>06 Oktober 2017</td>
               ...
               <tr>
                ...
                <td>Koordinasi P Aset : -Koordinasi antara Administrasi Aset dengan Pemeliharaan Aset</td>
                <td>Agus 081914067428</td>
                <td><i class="fa-solid fa-circle-dot mr-2"></i>Dibatalkan</td>
                <td><i class="fa-solid fa-question bg-info p-2 text-white rounded" data-toogle="tooltip" title="Info"></i></td>
              </tr>
               <tr>
                <th scope="row">4</th>
